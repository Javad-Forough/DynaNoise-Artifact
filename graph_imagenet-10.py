...
if __name__ == "__main__":
    ...
    # out_png = os.path.join(fig_folder, "imagenet-10_base_variance_comparison.png")
    # out_png = os.path.join(fig_folder, "imagenet-10_lambda_scale_comparison.png")
    out_png = os.path.join(fig_folder, "imagenet-10_temperature_comparison.png")
