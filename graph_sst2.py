...
if __name__ == "__main__":
    ...
    out_png = os.path.join(fig_folder, "sst2_base_variance_comparison.png")
    # out_png = os.path.join(fig_folder, "sst2_lambda_scale_comparison.png")
    # out_png = os.path.join(fig_folder, "sst2_temperature_comparison.png")
